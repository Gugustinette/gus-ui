...
.gus_checkbox_icon {
    ...
    width: 100%;
    transition: 0.1s;
    fill: var(--gus-ui-color-on-primary);
}
.gus_checkbox_icon * {
    fill: var(--gus-ui-color-on-primary);
}
